        ...
        <div class="relative flex items-top justify-center min-h-screen  sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    ...
                    <pre><font color="black" face="ゴシック体">新規登録はRegisterから</font></pre>
                        <pre><font color="black" face="ゴシック体">登録がお済みの方はLoginから</font></pre>
                        <pre><font color="black" face="ゴシック体">Login済みの方はHomeから</font></pre>
                    </div>
                </div>
            </div> 
        </div>
            ...
            <div class="button">
              @auth
                    <a href="{{ url('/home') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">
                        <button id="Home-start">Home</button>
                    </a>
              @else
                    <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">
                        <button id="login-start">Log in</button>
                        </a>
