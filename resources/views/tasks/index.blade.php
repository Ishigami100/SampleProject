...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style media ="screen">
            ...
            video{max-width:100%;height:auto}.bg-white{--bg-opacity:1;background-color:#fff;background-color:rgba(255,255,255,var(--bg-opacity))}
            ...
            .md\:border-l{border-left-width:1px}.md\:grid-cols-2{grid-template-columns:repeat(2,minmax(0,1fr))}}
    ...
    <body class="antialiased">
        ...
        <header>
         <div>
         <p><font color="white" style="ゴシック体">ToDoアプリ</font></p>
         <!--<img src="../image/ロゴ.png" width="400px" height="200px">-->
         </div>
        </header>
    ...
    <main>
        <div class="relative flex items-top justify-center min-h-screen  sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                 <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                  <p style="text-align:center">Start your task!</p><br>
                    <!--<img src="../image/ロゴ.png" width="400px" height="200px">-->
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    ...
                    <div class="ml-4 text-center text-sm text-gray-200 sm:text-right sm:ml-0">
            ...
            <div class="button" style="text-align:center">
             <button type="submit" style="text-align:center" color="navy">
                    <font color="black" face="ゴシック体">追加する</font>
                </button>
            </div>
            </form>
            @if ($tasks->isNotEmpty())
    ...
    <footer>
        <div>
            <p><font color="white" style="ゴシック体">ToDoアプリ</font></p>
            <!--<img src="../image/ロゴ.png" width="400px" height="200px">-->
            <a href="{{ url('/home') }}"><font color="orange">🏠ホームに戻る</font></a>
        </div>
    </footer>
